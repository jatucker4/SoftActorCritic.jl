...
mutable struct ReplayBuffer
    ...
    rew_buf::Vector{Vector{Float32}}        # stores rewards
...
function ReplayBuffer(obs_dim::Int, act_dim::Int, max_size::Int)
    ...
    rew_buf = [zeros(Float32, 3) for _ in 1:max_size]
...
#     temp_rew = buf.rew_buf[idxs]
#     reshaped_rew = [reshape(q,(1,3)) for q in temp_rew]
#     final_rew = vcat(reshaped_rew...)
#     batch = (
